...
impl Tooling {
    ...
    pub fn format_snippet(
        ...
        let (commands, set_args_fn, is_stdin): (
            ...
            Self::Alex => (&alex::COMMANDS, alex::set_args, alex::IS_STDIN),
            Self::Ameba => (&ameba::COMMANDS, ameba::set_args, ameba::IS_STDIN),
            Self::AnsibleLint => (
            ...
            Self::AutoOptional => (
                ...
                auto_optional::IS_STDIN,
            ),
            Self::Autocorrect => (
                &autocorrect::COMMANDS,
                autocorrect::set_args,
                autocorrect::IS_STDIN,
            ),
            Self::Autoflake => (
                &autoflake::COMMANDS,
                autoflake::set_args,
            ...
            Self::Bashate => (&bashate::COMMANDS, bashate::set_args, bashate::IS_STDIN),
            Self::BeancountBlack => (
                &beancount_black::COMMANDS,
                beancount_black::set_args,
                beancount_black::IS_STDIN,
            ),
            Self::Beautysh => (&beautysh::COMMANDS, beautysh::set_args, beautysh::IS_STDIN),
            Self::BibtexTidy => (
                &bibtex_tidy::COMMANDS,
                bibtex_tidy::set_args,
                bibtex_tidy::IS_STDIN,
            ),
            Self::BicepFormat => (
                &bicep_format::COMMANDS,
                bicep_format::set_args,
                bicep_format::IS_STDIN,
            ),
            Self::BiomeCheck => (
                &biome_check::COMMANDS,
                biome_check::set_args,
                biome_check::IS_STDIN,
            ),
            Self::BiomeCheckUnsafe => (
                &biome_check_unsafe::COMMANDS,
                biome_check_unsafe::set_args,
                biome_check_unsafe::IS_STDIN,
            ),
            Self::BiomeFormat => (
                &biome_format::COMMANDS,
                biome_format::set_args,
                biome_format::IS_STDIN,
            ),
            Self::BiomeLint => (
                &biome_lint::COMMANDS,
                biome_lint::set_args,
            ...
            Self::BiomeLintUnsafe => (
                ...
                biome_lint_unsafe::IS_STDIN,
            ),
            Self::Black => (&black::COMMANDS, black::set_args, black::IS_STDIN),
            Self::BladeFormatter => (
                &blade_formatter::COMMANDS,
                blade_formatter::set_args,
                blade_formatter::IS_STDIN,
            ),
            Self::Blue => (&blue::COMMANDS, blue::set_args, blue::IS_STDIN),
            Self::Bpfmt => (&bpfmt::COMMANDS, bpfmt::set_args, bpfmt::IS_STDIN),
            Self::Brittany => (&brittany::COMMANDS, brittany::set_args, brittany::IS_STDIN),
            Self::Brunette => (&brunette::COMMANDS, brunette::set_args, brunette::IS_STDIN),
            Self::Bsfmt => (&bsfmt::COMMANDS, bsfmt::set_args, bsfmt::IS_STDIN),
            Self::Bslint => (&bslint::COMMANDS, bslint::set_args, bslint::IS_STDIN),
            Self::BufFormat => (
                &buf_format::COMMANDS,
                buf_format::set_args,
                buf_format::IS_STDIN,
            ),
            Self::BufLint => (&buf_lint::COMMANDS, buf_lint::set_args, buf_lint::IS_STDIN),
            Self::Buildifier => (
                &buildifier::COMMANDS,
                buildifier::set_args,
                buildifier::IS_STDIN,
            ...
            Self::ClangFormat => (
                ...
                clang_format::set_args,
                clang_format::IS_STDIN,
            ),
            Self::ClangTidy => (
                &clang_tidy::COMMANDS,
                clang_tidy::set_args,
            ...
            Self::Cljstyle => (&cljstyle::COMMANDS, cljstyle::set_args, cljstyle::IS_STDIN),
            Self::CmakeFormat => (
            ...
            Self::Cppcheck => (&cppcheck::COMMANDS, cppcheck::set_args, cppcheck::IS_STDIN),
            Self::Cpplint => (&cpplint::COMMANDS, cpplint::set_args, cpplint::IS_STDIN),
            Self::Crlfmt => (&crlfmt::COMMANDS, crlfmt::set_args, crlfmt::IS_STDIN),
            Self::CrystalFormat => (
                &crystal_format::COMMANDS,
                crystal_format::set_args,
                crystal_format::IS_STDIN,
            ),
            Self::Csharpier => (
                &csharpier::COMMANDS,
                csharpier::set_args,
            ...
            Self::CssBeautify => (
                ...
                css_beautify::set_args,
                css_beautify::IS_STDIN,
            ),
            ...
            Self::D2Fmt => (&d_2_fmt::COMMANDS, d_2_fmt::set_args, d_2_fmt::IS_STDIN),
            Self::DartFix => (&dart_fix::COMMANDS, dart_fix::set_args, dart_fix::IS_STDIN),
            Self::DartFormat => (
                &dart_format::COMMANDS,
                dart_format::set_args,
                dart_format::IS_STDIN,
            ),
            Self::DcmFix => (&dcm_fix::COMMANDS, dcm_fix::set_args, dcm_fix::IS_STDIN),
            Self::DcmFormat => (
                &dcm_format::COMMANDS,
                dcm_format::set_args,
                dcm_format::IS_STDIN,
            ),
            Self::Deadnix => (&deadnix::COMMANDS, deadnix::set_args, deadnix::IS_STDIN),
            Self::DenoFmt => (&deno_fmt::COMMANDS, deno_fmt::set_args, deno_fmt::IS_STDIN),
            Self::DenoLint => (
                &deno_lint::COMMANDS,
                deno_lint::set_args,
                deno_lint::IS_STDIN,
            ...
            Self::Doctoc => (&doctoc::COMMANDS, doctoc::set_args, doctoc::IS_STDIN),
            Self::DotenvLinterFix => (
                &dotenv_linter_fix::COMMANDS,
                dotenv_linter_fix::set_args,
                dotenv_linter_fix::IS_STDIN,
            ),
            Self::DprintFmt => (
                &dprint_fmt::COMMANDS,
                dprint_fmt::set_args,
            ...
            Self::EasyCodingStandard => (
                ...
                easy_coding_standard::IS_STDIN,
            ),
            Self::Efmt => (&efmt::COMMANDS, efmt::set_args, efmt::IS_STDIN),
            Self::ElmFormat => (
                &elm_format::COMMANDS,
                elm_format::set_args,
                elm_format::IS_STDIN,
            ...
            Self::Gofmt => (&gofmt::COMMANDS, gofmt::set_args, gofmt::IS_STDIN),
            Self::Gofumpt => (&gofumpt::COMMANDS, gofumpt::set_args, gofumpt::IS_STDIN),
            Self::Goimports => (
                &goimports::COMMANDS,
                goimports::set_args,
                goimports::IS_STDIN,
            ...
            Self::GrainFormat => (
                ...
                grain_format::IS_STDIN,
            ),
            Self::Hadolint => (&hadolint::COMMANDS, hadolint::set_args, hadolint::IS_STDIN),
            Self::HamlLint => (
                &haml_lint::COMMANDS,
                haml_lint::set_args,
                haml_lint::IS_STDIN,
            ...
            Self::HtmlBeautify => (
                ...
                html_beautify::IS_STDIN,
            ),
            Self::Htmlbeautifier => (
                &htmlbeautifier::COMMANDS,
                htmlbeautifier::set_args,
                htmlbeautifier::IS_STDIN,
            ),
            Self::Htmlhint => (&htmlhint::COMMANDS, htmlhint::set_args, htmlhint::IS_STDIN),
            Self::Hurlfmt => (&hurlfmt::COMMANDS, hurlfmt::set_args, hurlfmt::IS_STDIN),
            ...
            Self::JsBeautify => (
                ...
                js_beautify::set_args,
                js_beautify::IS_STDIN,
            ),
            Self::Json5Format => (
            ...
            Self::JuliaformatterJl => (
                ...
                juliaformatter_jl::IS_STDIN,
            ),
            Self::Just => (&just::COMMANDS, just::set_args, just::IS_STDIN),
            ...
            Self::LiquidsoapPrettier => (
                ...
                liquidsoap_prettier::IS_STDIN,
            ),
            Self::Luacheck => (&luacheck::COMMANDS, luacheck::set_args, luacheck::IS_STDIN),
            Self::Luaformatter => (
            ...
            Self::MojoFormat => (
                ...
                mojo_format::set_args,
                mojo_format::IS_STDIN,
            ),
            Self::MuonFmt => (&muon_fmt::COMMANDS, muon_fmt::set_args, muon_fmt::IS_STDIN),
            Self::MuonLint => (
                &muon_lint::COMMANDS,
                muon_lint::set_args,
                muon_lint::IS_STDIN,
            ),
            Self::Mypy => (&mypy::COMMANDS, mypy::set_args, mypy::IS_STDIN),
            Self::Nasmfmt => (&nasmfmt::COMMANDS, nasmfmt::set_args, nasmfmt::IS_STDIN),
            Self::Nginxbeautifier => (
                &nginxbeautifier::COMMANDS,
                nginxbeautifier::set_args,
                nginxbeautifier::IS_STDIN,
            ),
            Self::Nginxfmt => (&nginxfmt::COMMANDS, nginxfmt::set_args, nginxfmt::IS_STDIN),
            Self::NickelFormat => (
                &nickel_format::COMMANDS,
                nickel_format::set_args,
                nickel_format::IS_STDIN,
            ),
            Self::Nimpretty => (
                &nimpretty::COMMANDS,
                nimpretty::set_args,
            ...
            Self::Nixfmt => (&nixfmt::COMMANDS, nixfmt::set_args, nixfmt::IS_STDIN),
            Self::NixpkgsFmt => (
                &nixpkgs_fmt::COMMANDS,
                nixpkgs_fmt::set_args,
                nixpkgs_fmt::IS_STDIN,
            ),
            Self::NomadFmt => (
                &nomad_fmt::COMMANDS,
                nomad_fmt::set_args,
            ...
            Self::Nph => (&nph::COMMANDS, nph::set_args, nph::IS_STDIN),
            Self::NpmGroovyLint => (
                &npm_groovy_lint::COMMANDS,
                npm_groovy_lint::set_args,
                npm_groovy_lint::IS_STDIN,
            ),
            Self::Nufmt => (&nufmt::COMMANDS, nufmt::set_args, nufmt::IS_STDIN),
            Self::Ocamlformat => (
                &ocamlformat::COMMANDS,
                ocamlformat::set_args,
                ocamlformat::IS_STDIN,
            ),
            Self::OcpIndent => (
                &ocp_indent::COMMANDS,
                ocp_indent::set_args,
            ...
            Self::Odinfmt => (&odinfmt::COMMANDS, odinfmt::set_args, odinfmt::IS_STDIN),
            Self::OelintAdv => (
                &oelint_adv::COMMANDS,
                oelint_adv::set_args,
                oelint_adv::IS_STDIN,
            ...
            Self::PhpCsFixerFix => (
                ...
                php_cs_fixer_fix::IS_STDIN,
            ),
            Self::Phpcbf => (&phpcbf::COMMANDS, phpcbf::set_args, phpcbf::IS_STDIN),
            Self::PhpinsightsFix => (
                &phpinsights_fix::COMMANDS,
                phpinsights_fix::set_args,
            ...
            Self::Ptop => (&ptop::COMMANDS, ptop::set_args, ptop::IS_STDIN),
            Self::PugLint => (&pug_lint::COMMANDS, pug_lint::set_args, pug_lint::IS_STDIN),
            Self::PuppetLint => (
                &puppet_lint::COMMANDS,
                puppet_lint::set_args,
                puppet_lint::IS_STDIN,
            ),
            Self::PursTidy => (
                &purs_tidy::COMMANDS,
                purs_tidy::set_args,
            ...
            Self::Purty => (&purty::COMMANDS, purty::set_args, purty::IS_STDIN),
            Self::Pycln => (&pycln::COMMANDS, pycln::set_args, pycln::IS_STDIN),
            Self::Pycodestyle => (
            ...
            Self::QuickLintJs => (
                ...
                quick_lint_js::IS_STDIN,
            ),
            Self::RacoFmt => (&raco_fmt::COMMANDS, raco_fmt::set_args, raco_fmt::IS_STDIN),
            Self::Reek => (&reek::COMMANDS, reek::set_args, reek::IS_STDIN),
            Self::Refmt => (&refmt::COMMANDS, refmt::set_args, refmt::IS_STDIN),
            ...
            Self::ReorderPythonImports => (
                ...
                reorder_python_imports::IS_STDIN,
            ),
            Self::RescriptFormat => (
                &rescript_format::COMMANDS,
                rescript_format::set_args,
                rescript_format::IS_STDIN,
            ),
            Self::Revive => (&revive::COMMANDS, revive::set_args, revive::IS_STDIN),
            Self::RocFormat => (
                &roc_format::COMMANDS,
                roc_format::set_args,
                roc_format::IS_STDIN,
            ),
            Self::Rstfmt => (&rstfmt::COMMANDS, rstfmt::set_args, rstfmt::IS_STDIN),
            Self::Rubocop => (&rubocop::COMMANDS, rubocop::set_args, rubocop::IS_STDIN),
            Self::Rubyfmt => (&rubyfmt::COMMANDS, rubyfmt::set_args, rubyfmt::IS_STDIN),
            Self::RuffCheck => (
                &ruff_check::COMMANDS,
                ruff_check::set_args,
                ruff_check::IS_STDIN,
            ...
            Self::Shellharden => (
                ...
                shellharden::set_args,
                shellharden::IS_STDIN,
            ),
            Self::Shfmt => (&shfmt::COMMANDS, shfmt::set_args, shfmt::IS_STDIN),
            Self::Sleek => (&sleek::COMMANDS, sleek::set_args, sleek::IS_STDIN),
            Self::SlimLint => (
                &slim_lint::COMMANDS,
                slim_lint::set_args,
                slim_lint::IS_STDIN,
            ),
            Self::Smlfmt => (&smlfmt::COMMANDS, smlfmt::set_args, smlfmt::IS_STDIN),
            Self::Snakefmt => (&snakefmt::COMMANDS, snakefmt::set_args, snakefmt::IS_STDIN),
            Self::Solhint => (&solhint::COMMANDS, solhint::set_args, solhint::IS_STDIN),
            Self::SphinxLint => (
                &sphinx_lint::COMMANDS,
                sphinx_lint::set_args,
                sphinx_lint::IS_STDIN,
            ),
            Self::SqlFormatter => (
                &sql_formatter::COMMANDS,
                sql_formatter::set_args,
                sql_formatter::IS_STDIN,
            ),
            Self::SqlfluffFix => (
                &sqlfluff_fix::COMMANDS,
                sqlfluff_fix::set_args,
                sqlfluff_fix::IS_STDIN,
            ),
            Self::SqlfluffFormat => (
                &sqlfluff_format::COMMANDS,
                sqlfluff_format::set_args,
                sqlfluff_format::IS_STDIN,
            ),
            Self::SqlfluffLint => (
                &sqlfluff_lint::COMMANDS,
                sqlfluff_lint::set_args,
            ...
            Self::StatixCheck => (
                ...
                statix_check::set_args,
                statix_check::IS_STDIN,
            ),
            Self::StatixFix => (
                &statix_fix::COMMANDS,
                statix_fix::set_args,
            ...
            Self::Stylefmt => (&stylefmt::COMMANDS, stylefmt::set_args, stylefmt::IS_STDIN),
            Self::Stylelint => (
                &stylelint::COMMANDS,
                stylelint::set_args,
                stylelint::IS_STDIN,
            ...
            Self::TerraformFmt => (
                ...
                terraform_fmt::set_args,
                terraform_fmt::IS_STDIN,
            ),
            ...
            Self::Ufmt => (&ufmt::COMMANDS, ufmt::set_args, ufmt::IS_STDIN),
            Self::UiuaFmt => (&uiua_fmt::COMMANDS, uiua_fmt::set_args, uiua_fmt::IS_STDIN),
            Self::Unimport => (&unimport::COMMANDS, unimport::set_args, unimport::IS_STDIN),
            Self::Usort => (&usort::COMMANDS, usort::set_args, usort::IS_STDIN),
            Self::VFmt => (&v_fmt::COMMANDS, v_fmt::set_args, v_fmt::IS_STDIN),
            Self::VacuumLint => (
            ...
            Self::VhdlStyleGuide => (
                ...
                vhdl_style_guide::IS_STDIN,
            ),
            Self::Vint => (&vint::COMMANDS, vint::set_args, vint::IS_STDIN),
            Self::VintNeovim => (
                &vint_neovim::COMMANDS,
                vint_neovim::set_args,
                vint_neovim::IS_STDIN,
            ),
            Self::WaFmt => (&wa_fmt::COMMANDS, wa_fmt::set_args, wa_fmt::IS_STDIN),
            Self::Wfindent => (&wfindent::COMMANDS, wfindent::set_args, wfindent::IS_STDIN),
            Self::WriteGood => (
                &write_good::COMMANDS,
                write_good::set_args,
                write_good::IS_STDIN,
            ...
            Self::Xmllint => (&xmllint::COMMANDS, xmllint::set_args, xmllint::IS_STDIN),
            Self::Xo => (&xo::COMMANDS, xo::set_args, xo::IS_STDIN),
            Self::Xq => (&xq::COMMANDS, xq::set_args, xq::IS_STDIN),
...
impl AsRef<str> for Tooling {
    ...
    fn as_ref(&self) -> &str {
        match self {
            ...
            Self::BibtexTidy => "bibtex-tidy",
            Self::BicepFormat => "bicep:format",
            Self::BiomeCheck => "biome:check",
            Self::BiomeCheckUnsafe => "biome:check:unsafe",
            Self::BiomeFormat => "biome:format",
            Self::BiomeLint => "biome:lint",
            Self::BiomeLintUnsafe => "biome:lint:unsafe",
            Self::Black => "black",
            ...
            Self::CljKondo => "clj-kondo",
            Self::CljfmtFix => "cljfmt:fix",
            Self::Cljstyle => "cljstyle",
            Self::CmakeFormat => "cmake-format",
            Self::CmakeLint => "cmake-lint",
            Self::CodeqlQueryFormat => "codeql:query:format",
            Self::Codespell => "codespell",
            Self::Coffeelint => "coffeelint",
            Self::Cppcheck => "cppcheck",
            Self::Cpplint => "cpplint",
            Self::Crlfmt => "crlfmt",
            Self::CrystalFormat => "crystal:format",
            ...
            Self::DartFormat => "dart:format",
            Self::DcmFix => "dcm:fix",
            Self::DcmFormat => "dcm:format",
            ...
            Self::RescriptFormat => "rescript:format",
            Self::Revive => "revive",
            Self::RocFormat => "roc:format",
            Self::Rstfmt => "rstfmt",
            ...
            Self::Shfmt => "shfmt",
            Self::Sleek => "sleek",
            Self::SlimLint => "slim-lint",
            Self::Smlfmt => "smlfmt",
            Self::Snakefmt => "snakefmt",
            Self::Solhint => "solhint",
            Self::SphinxLint => "sphinx-lint",
            Self::SqlFormatter => "sql-formatter",
            Self::SqlfluffFix => "sqlfluff:fix",
            ...
            Self::Vint => "vint",
            Self::VintNeovim => "vint:neovim",
            Self::WaFmt => "wa:fmt",
            Self::Wfindent => "wfindent",
            Self::WriteGood => "write-good",
