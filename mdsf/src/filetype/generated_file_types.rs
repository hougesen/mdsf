...
pub fn language_to_ext(language: &str) -> Option<&'static str> {
    ...
    match language.to_lowercase().as_str() {
        ...
        "imba" => Some(".imba"),
        "imhex pattern language" => Some(".hexpat"),
        "imhex" => Some(".hexpat"),
        "imhexpatternlanguage" => Some(".hexpat"),
        "imhexpl" => Some(".hexpat"),
        "inc" => Some(".php"),
        "inform 7" => Some(".ni"),
        "inform7" => Some(".ni"),
        ...
        "mathematical programming system" => Some(".mps"),
        "matlab" => Some(".matlab"),
        "max" => Some(".maxpat"),
        "max/msp" => Some(".maxpat"),
        "maxmsp" => Some(".maxpat"),
        ...
        "tabular model definition language" => Some(".tmdl"),
        "tact" => Some(".tact"),
        "talon" => Some(".talon"),
        "tape" => Some(".tape"),
        "tcl" => Some(".tcl"),
...
mod test_language_to_ext {
    ...
    fn test_pairings() {
        ...
        for (input, output) in cases {
            assert!(language_to_ext(input).is_some_and(|o| o == output));
        }
    }
}
